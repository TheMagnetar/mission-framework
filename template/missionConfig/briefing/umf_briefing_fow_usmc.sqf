//=======================================================================================================//
// File: umf_briefing_fow_usmc.sqf                                                                       //
// Author: TheMagnetar                                                                                   //
// Version: 1.0                                                                                          //
// File creation: 2017/11/07                                                                             //
// Description: This document generates the mission briefing for units belonging to the Faces of War     //
//              faction United States Marine Corps "fow_usmc"                                            //
//                                                                                                       //
//              Arguments:                                                                               //
//               - none                                                                                  //
//                                                                                                       //
